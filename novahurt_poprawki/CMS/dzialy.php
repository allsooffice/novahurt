...
include('php/db_connect.php');
   ...
   {
      if($_POST['choosen'] == 'meble_biurowe')
      {
         $dzial = 'Meble biurowe';
      }
      
      if($_POST['choosen'] == 'agd')
      {
         $dzial = 'AGD';
      }
      
      if($_POST['choosen'] == 'stoly')
      {
         $dzial = 'Stoły';
      }
       if($_POST['choosen'] == 'krzesla')
      {
         $dzial = 'Krzesła';
      }
      
      if($_POST['choosen'] == 'dzieciece')
      {
               ...
               <li>Kategoria:
                  <form method="post" id="category-form">
                   <select id="category" class="selected-order" name="choosen">
                       ...
                       <option value="stoly">Stoły</option>
