...
<body>
    ...
    <div id="contener">
        ...
        <div id="content_dzialy">
            ...
            <a href="../krzesla.php#start">
            <div id="dzial_krzesla">
                <div class="tittle">krzesła</div>
                
            </div>
            </a>
              
            <a href="../stoly.php#start">
            <div id="dzial_stoly">
                <div class="tittle">stoły</div>
                
            </div>
            </a>
               
             <a href="../agd.php#start">
            <div id="dzial_stoly"  style="background-image: url(../jpg/agd.jpg);">
              ...
              <div class="galeria">
                  <ol>
                    ...
                    while ($galeria_img=mysqli_fetch_array($galeria) )
                    {
                        if ($i == 1)
                        {
                           echo '<li id="'.$i.'" class="visible-image"><img src="../products_img/'.$galeria_img['image_src'].'" ondragstart="return false"/></li><div class="img-loader"></div>';
                        }
                        else
                        {
                          echo '<li id="'.$i.'"><img src="../products_img/'.$galeria_img['image_src'].'" ondragstart="return false"/></li><div class="img-loader"></div>'; 
                        }
                ...
                <div class="product-left">
                    <div class="produkt_prawa">
                        ...
                        <table>
                            ...
                            <tr>
                                <td>Przesyłka kurierska Express</td>
                                <td><?php echo $dostawa+6; ?> zł</td>
                                <?php if($sztuk_w_paczce > 1)
                                 {
                            ...
                            <tr>
                                <td>Przesyłka kurierska pobraniowa Express</td>
                                <td><?php echo $pobranie+6; ?> zł</td>
                                <?php if($sztuk_w_paczce > 1)
                                 {
                                   echo '<td> '.$kolejna_sztuka. ' zł</td>';
                                 } ?>
                ...
                <div class="produkt_prawa_price" style="font-size: 24px; text-align: right;">
                        <?php 
                           if($crossed_price != 0)
                           {
                            echo '<div class="crossed-price-product" style="color: black;">Cena detaliczna: '.$crossed_price.'.00 zł</div>';
                           }
                         ?>
                        <?php $c = number_format ($cena,2,',','')?>
                      Cena detaliczna: <b><?php echo $c; ?></b> zł (z VAT)
                </div>
                <div class="card">
                        <form method="post">
                          Sztuk:
                ...
                if($instrukcja == 'tak')
                   echo'
                     <div class="instrukcja">
                        <a href="instrukcja.pdf" style="color: black;" target="_blank"><img src="../jpg/instr_download.jpg" alt="Download PDF" style="margin-top: 30px;"><br>Instrukcja użytkowania fotela</a>
                     </div>';
               ?>
