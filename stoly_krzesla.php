...
<body>
    ...
    ?>
        ...
        <div id="tresc_informator"><a name="start"></a>
            <div class="tytuly">stoły i krzesła</div>
            
            <?php
                $rezultat = $mysqli->query("SELECT * FROM produkty WHERE dzial = 'Stoły / Krzesła' AND wyswietlac <> 'Nie' AND wyswietlac <> 'Archiwum' ORDER BY category_place");
