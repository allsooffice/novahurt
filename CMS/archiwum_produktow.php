...
<head>
	...
	<title>Archiwum produktów - Panel Administracyjny</title>
...
<body>
   ...
   <div class="box">
    ...
    <div class="wrapper">
        ...
        <div class="content">
            <h1>Archiwum produktów:</h1>
            <form method="post" action="php/replace_adv.php">
            <ul class="table">
               <?php
            $i = 1;
            $pobieranie = $mysqli->query("SELECT * FROM produkty WHERE wyswietlac = 'archiwum'");
...
<script>
		$("#cat-archiwum").addClass("active-color");
		$("#cat-archiwum").parent().addClass("menu-active");
</script>
</html>