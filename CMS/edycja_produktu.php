  ...
  <?php
   ...
   <div class="box">
       <div class="popup">
           ...
           <ul>
               <li><a href="javascript:history.back()">Lista prduktów</a></li>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <input type="hidden" id="last_name" value="<?php echo $model ?>">
            <hr>
            ...
            <h3>Dział :</h3>
              ...
              <label><input type="radio" name="cat" id="dzial" value="Stoły / Krzesła" <?php if($dzial == 'Stoły / Krzesła') echo 'checked';?>> Stoły / Krzesła</label>
            ...
            <h3>Wyświetlać :</h3>
              ...
              <hr>
              <h3>Dodaj podobny :</h3><span class="span-add-item" style="margin-right: 22%;"><a href="wystaw_podobny.php?id=<?php echo $art_id?>"><i class="icon-plus"></i> Dodaj podobny produkt</a>
              </span>
              <hr>
