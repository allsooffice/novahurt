...
//MAIL DO KLIENTA
   ...
   $subj_client = 'Brak płatności do zamówienia: '.$sygnatura.' - NOVA HURT';
	 $message_client ='
            ...
            <tr>
                ...
                <center>Z przykrością informujemy, że do chwili obecnej nie możemy zrealizować zamówienia z powodu braku płatności. Aby sfinalizowac zamówienie prosimy o dokonanie płatności</center>
                </td>
            </tr>
