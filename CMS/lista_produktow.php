...
$usuwanie = "DELETE FROM produkty WHERE dzial = ''";
...
<head>
	...
	<title>Lista produktów - Panel Administracyjny</title>
   ...
   <div class="box">
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <form method="post" action="php/replace_adv.php">
            <ul class="table">
               <?php
            $i = 1;
            $pobieranie = $mysqli->query("SELECT * FROM produkty WHERE wyswietlac <> 'archiwum' ORDER BY place");
...
<script>
		$("#edit-article").parent().addClass("menu-active");
		$("#edit-article").addClass("active-color");
</script>
</html>