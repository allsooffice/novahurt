<?php
    ...
    $dubel = $mysqli->query("SELECT * FROM card WHERE session_id = '$client_id'");
       ...
       if($ile_takich_produktow < 1)
    {
        ...
        $_SESSION['koszykZero'] = '<a href="koszyk.php#start"> Koszyk <img src="jpg/koszyk/pusty.jpg" width="35"></a>';
    }
