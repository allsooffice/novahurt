...
<body>
    ...
    ?>
        <div id="tresc_informator"><a name="start"></a>
            <div class="tytuly">meble biurowe</div>
            
            <?php
                $rezultat = $mysqli->query("SELECT * FROM produkty WHERE dzial = 'Meble biurowe' AND wyswietlac <> 'Nie' AND wyswietlac <> 'Archiwum' ORDER BY category_place");
